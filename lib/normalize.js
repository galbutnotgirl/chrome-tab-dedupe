...
export const RULES = [
  {
    id: 'google-docs',
    label: 'Any slide, sheet tab, or heading',
    site: 'Google Docs, Sheets, Slides',
    key(u, host) {
  ...
  {
    id: 'jira',
    label: 'Board link or direct link',
    site: 'Jira',
    key(u, host) {
  ...
  {
    id: 'confluence',
    label: 'Ignores the title in the URL',
    site: 'Confluence',
    key(u, host) {
      if (!host.endsWith('.atlassian.net')) return null;
  ...
  {
    id: 'figma',
    label: 'Any page, node, or present mode',
    site: 'Figma',
    key(u, host) {
  ...
  {
    id: 'youtube',
    label: 'Ignores timestamp and playlist',
    site: 'YouTube',
    key(u, host) {
      if (host === 'youtu.be') {
